...
# print("\n✅ Metrics saved to models/training_metrics.txt")
...
# -------------------
batch_size = 32
num_epochs = 100  # reduced for testing, increase as needed
input_shape = (48, 48, 1)
...
x_train, x_test, y_train, y_test = train_test_split(
    faces, emotions, test_size=validation_split, shuffle=True
)
